<template>
  <div class="mt-12">
    <div
      class="px-3 py-6 lg:p-12 bg-lightblue rounded grid gap-10 lg:gap-12 grid-cols-1 md:grid-cols-2 text-white"
    >
      <div>
        <Newsletter class="md:hidden" />
        <Donation class="md:hidden my-4" />
        <p class="mb-4 text-xl lg:text-2xl font-sans font-bold text-azure">
          Liens utiles
        </p>
        <nav class="space-y-2 text-sm">
          ...
          <a
            class="text-gray-300 hover:text-white block link font-sans"
            href="https://www.christians-muslims.com/fr"
            target="_blank"
            >La Fraternité pour la Connaissance et la Coopération</a
          >
          <a
            class="text-gray-300 hover:text-white block link font-sans"
            href="https://www.ifcm-lyon.org/"
            target="_blank"
            >Institut Français de Civilisation Musulmane (I.F.C.M.)</a
          >
          <a
            class="text-gray-300 hover:text-white block link font-sans"
            href="http://www.accademiaisa.it/"
            target="_blank"
            >I.S.A. Interreligious Studies Academy</a
          >
        </nav>
      </div>
      <div>
        ...
        <form
          class="space-y-4"
          action="https://formcarry.com/s/dMeHyLbpw-"
          method="POST"
          accept-charset="UTF-8"
        >
          <input
            class="rounded bg-transparent border-2 border-white px-2 py-1 w-full"
            name="Email"
            type="email"
            placeholder="email"
          />
          <textarea
            class="rounded bg-transparent border-2 border-white p-2 w-full"
            name="Message"
            placeholder="message"
          ></textarea>
          <input
            type="submit"
            value="Envoyer"
            class="font-sans bg-transparent border-gray-200 border-2 font-bold text-gray-200 shadow rounded px-4 py-2 hover:border-gray-100 hover:shadow-lg hover:text-gray-100 focus:shadow-none focus:border-gray-300 focus:text-gray-300 transition duration-75"
          />
          <label
    ...
    <footer class="my-grid mt-6 font-sans md:text-sm">
      <div class="space-y-2 hidden md:block">
        ...
        <p>
          <a
            ...
            href="https://www.facebook.com/IHEI.Jeunes"
            target="_blank"
          >
            <svg
      ...
      <div class="md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <nav class="space-y-1">
          <n-link class="font-bold pb-2 block" to="/publications/"
            >Publications</n-link
          >
          <n-link
            class="block"
